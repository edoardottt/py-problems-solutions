...
def matrice(n,i,j):
    if(i==n):   # if I finish the rows, print it
        ...
        if(M[i-1][j]==0 and M[i-1][j+1]==0): # check if the adjacents inserted yet are equal to 0
            M[i][j]  = 1
            matrice(n,i,j+1)
            M[i][j] = 0
            matrice(n,i,j+1)
        ...
        if(M[i][j-1]==0 and M[i-1][j-1]==0 and M[i-1][j]==0):# check if the adjacents inserted yet are equal to 0
            M[i][j]  = 1
            matrice(n,i,j+1)
            M[i][j] = 0
            matrice(n,i,j+1)
        ...
        if(M[i][j-1]==0 and M[i-1][j-1]==0 and M[i-1][j]==0 and M[i-1][j+1]==0):# check if the adjacents inserted yet are equal to 0
            M[i][j]  = 1
            matrice(n,i,j+1)
            M[i][j] = 0
            matrice(n,i,j+1)
